...
builder.Services.AddScoped<IProductDefaultComponentRepository, ProductDefaultComponentRepository>();
...
builder.Services.AddScoped<IJobCardMaterialRequirementRepository, JobCardMaterialRequirementRepository>();
...
builder.Services.AddScoped<IShopFloorComponentStockRepository, ShopFloorComponentStockRepository>();
builder.Services.AddScoped<IOrderComponentRepository, OrderComponentRepository>();
...
builder.Services.AddScoped<IComponentConsumptionService, ComponentConsumptionService>();
...
builder.Services.AddScoped<IProcessMachineCapabilityService, ProcessMachineCapabilityService>();
